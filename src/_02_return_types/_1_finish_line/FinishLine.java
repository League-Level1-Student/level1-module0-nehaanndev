...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		int totalDis = getTotalDistance();
		//4. Call the hasCrossedFinishLine() method and save what is returned into a variable
		Boolean crossedLine	 = hasCrossedFinishLine();
		//5. If the robot has crossed the finish line... 
		if (crossedLine == true) {
			//6. Use a pop up to say the robot finished and how far it went
			JOptionPane.showMessageDialog(null, "The robot finished and it went a total distance of " + totalDis);
		}else {
			JOptionPane.showMessageDialog(null, "The robot did not finish but it went a total distance of " + totalDis);
		}
